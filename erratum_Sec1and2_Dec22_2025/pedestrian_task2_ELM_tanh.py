"""
Source code for task.II using ELM (tanh activation)
"""
import numpy as np
import time
import os
...
class Env:
   ...
   def _step(self, t):
      ...
      for i_agent in range(self.n_agent):
         ...
         self.agents[i_agent].action, self.agents[i_agent].Xi_temp_part1 = self.agents[i_agent].choose_action(state)
      ...
      for i_agent in range(self.n_agent):
         ...
         if t >= 1 :
            ...
            if self.experience_sharing == 'on':
               if self.agents[i_agent].group == 0 :
                  ...
                  self.agents[self.n_agent_1group].reward_list.append(self.agents[i_agent].reward_past)
                  self.agents[self.n_agent_1group].Xi_temp_list.append(Xi_temp)
                  self.agents[self.n_agent_1group].Xi_temp_p0_list.append(self.agents[i_agent].Xi_temp_part0)
         ...
         if self.done:
            ...
            if self.experience_sharing == 'on':
               ...
               if self.agents[i_agent].group == 1 :
                  self.agents[self.n_agent_1group].reward_list.append(0.0)
                  self.agents[self.n_agent_1group].Xi_temp_list.append(self.agents[i_agent].Xi_temp_part1)
                  self.agents[self.n_agent_1group].Xi_temp_p0_list.append(self.agents[i_agent].Xi_temp_part1)
            elif self.experience_sharing == 'off':
...
class Agent(Object):
   ...
   def choose_action(self, state): #epsilon-greedy
      ...
      Input_state = np.repeat( (self.W_in_s*self.X_in).reshape(-1,1), self.action_size, axis=1)
      X_esn_candidates = np.tanh( Input_state + self.W_in_a )
      ...
      return action_chosen, copy.deepcopy( np.concatenate([self.X_esn,[1.0]]) )  # returns action and corresponding X_res
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   filename_density = "density_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.gif"
   
   filename_snap1 = "snapshot_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_0_" + str(seed) + "th_try.png"
   filename_snap2 = "snapshot_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_100_" + str(seed) + "th_try.png"
   filename_snap3 = "snapshot_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_" + str(t_max-1) + "_" + str(seed) + "th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "group1_" + str(seed) + "th_try.png"
   ...
   filename_colormap = "colormap_ELM_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "group2_" + str(seed) + "th_try.png"
   mean_view_white = (255.0*mean_view.transpose(1,0,2)).astype(np.uint8)
