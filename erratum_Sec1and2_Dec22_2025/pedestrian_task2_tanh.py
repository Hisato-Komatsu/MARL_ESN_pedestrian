...
class Agent(Object):
   ...
   def choose_action(self, state): #epsilon-greedy
      ...
      self.X_esn_tilde = np.tanh( Input_state + self.W_in_a )
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   filename_density = "density_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.gif"
   
   filename_snap1 = "snapshot_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_0_" + str(seed) + "th_try.png"
   filename_snap2 = "snapshot_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_100_" + str(seed) + "th_try.png"
   filename_snap3 = "snapshot_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_" + str(t_max-1) + "_" + str(seed) + "th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "group1_" + str(seed) + "th_try.png"
   ...
   filename_colormap = "colormap_tanh_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "group2_" + str(seed) + "th_try.png"
   mean_view_white = (255.0*mean_view.transpose(1,0,2)).astype(np.uint8)
