...
class Env:
   ...
   def _step(self, t):
      ...
      for i_agent in range(self.n_agent):
         ...
         self.agents[i_agent].action = self.net[self.agents[i_agent].group].choose_action( self.agents[i_agent].state[None, :] )
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_DQN_Huber_swr_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_mbsize_" + str(hyper.batch_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.txt"
   filename_density = "density_DQN_Huber_swr_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_mbsize_" + str(hyper.batch_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_DQN_Huber_swr_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_mbsize_" + str(hyper.batch_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_DQN_Huber_swr_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_mbsize_" + str(hyper.batch_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.gif"
   
   filename_snap1 = "snapshot_DQN_Huber_swr_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_mbsize_" + str(hyper.memory_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_0_" + str(seed) + "_th_try.png"
   filename_snap2 = "snapshot_DQN_Huber_swr_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_mbsize_" + str(hyper.batch_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_100_" + str(seed) + "_th_try.png"
   filename_snap3 = "snapshot_DQN_Huber_swr_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_mbsize_" + str(hyper.batch_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_" + str(t_max-1) + "_" + str(seed) + "_th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_DQN_Huber_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_memsize_" + str(hyper.memory_size) + "_init_distr_torchdefault_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_group1_" + str(seed) + "_th_try.png"
