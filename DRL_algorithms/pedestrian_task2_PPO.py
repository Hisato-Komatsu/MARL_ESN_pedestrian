"""
Source code for task.II using PPO
"""
import numpy as np
import time
import os
...
class Env:
   def __init__(self, hyperparameters, render_mode='off', experience_sharing='on'):
      ...
      for i_group in range(self.n_group):
         ...
         self.whole_mem_states[i_group] = deque([], maxlen=self.batch_size_agentwise*self.n_agent_1group)
         self.whole_mem_actions[i_group] = deque([], maxlen=self.batch_size_agentwise*self.n_agent_1group)
         self.whole_R_values[i_group] = np.zeros( (0,1) )
         self.whole_GAE_values[i_group] = np.zeros( (0,1) )
         self.whole_mem_Rs[i_group] = deque([], maxlen=self.batch_size_agentwise*self.n_agent_1group)
         self.whole_mem_GAEs[i_group] = deque([], maxlen=self.batch_size_agentwise*self.n_agent_1group)
         self.whole_mem_probs[i_group] = deque([], maxlen=self.batch_size_agentwise*self.n_agent_1group)
   ...
   def _step(self, t):
      ...
      if self.done or (t+1)%self.num_step ==0 :
         ...
         for i_group in range(self.n_group):
            self.whole_mem_Rs[i_group] += self.whole_R_values[i_group].tolist()
            self.whole_mem_GAEs[i_group] += self.whole_GAE_values[i_group].tolist()
         ...
         for i_group in range(self.n_group):
            ...
            tensor_mem_Rs = torch.tensor( list(self.whole_mem_Rs[i_group]) )
            tensor_mem_GAEs = torch.tensor( list(self.whole_mem_GAEs[i_group]) )
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.txt"
   filename_density = "density_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.gif"
   
   filename_snap1 = "snapshot_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_t_0_" + str(seed) + "th_try.png"
   filename_snap2 = "snapshot_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_t_100_" + str(seed) + "th_try.png"
   filename_snap3 = "snapshot_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_t_" + str(t_max-1) + "_" + str(seed) + "th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_group1_" + str(seed) + "th_try.png"
   ...
   filename_colormap = "colormap_PPO_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_group2_" + str(seed) + "th_try.png"
   mean_view_white = (255.0*mean_view.transpose(1,0,2)).astype(np.uint8)
