...
class Env:
   ...
   def _step(self, t):
      ...
      for i_agent in range(self.n_agent):
         ...
         with torch.no_grad() :
            q_temp = self.net.forward( self.agents[i_agent].state[None, :] )
         self.agents[i_agent].action = self.net.choose_action(q_temp)
...
class WholeNet():
   ...
   def memory_sample(self, device="cpu"):
      ...
      res = []
      #print(batch)
      #print(tuple(item[1] for item in batch))
      for i in range(5):
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_DQN_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_memsize_" + str(hyper.memory_size) + "_init_distr_torchdefault_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.txt"
   filename_density = "density_DQN_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_memsize_" + str(hyper.memory_size) + "_init_distr_torchdefault_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_DQN_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_memsize_" + str(hyper.memory_size) + "_init_distr_torchdefault_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_DQN_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_memsize_" + str(hyper.memory_size) + "_init_distr_torchdefault_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.gif"
   
   filename_snap1 = "snapshot_DQN_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_memsize_" + str(hyper.memory_size) + "_init_distr_torchdefault_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_0_" + str(seed) + "_th_try.png"
   filename_snap2 = "snapshot_DQN_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_memsize_" + str(hyper.memory_size) + "_init_distr_torchdefault_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_100_" + str(seed) + "_th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_DQN_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_memsize_" + str(hyper.memory_size) + "_init_distr_torchdefault_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "_th_try.png"
