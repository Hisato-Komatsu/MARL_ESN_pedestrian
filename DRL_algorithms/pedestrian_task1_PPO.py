"""
Source code for task.I using PPO
"""
import numpy as np
import time
import os
...
class hyperparameters:
   def __init__(self):
      ...
      self.num_step = 125
      self.num_epochs = 4
      self.minibatch_size = self.num_step
      self.batch_size_agentwise = 4 * self.minibatch_size
...
class Env:
   def __init__(self, hyperparameters, render_mode='off', experience_sharing='on'):
      ...
      self.batch_size_agentwise = self.hyperparameters.batch_size_agentwise
      self.done = False
      ...
      self.whole_mem_states = deque([], maxlen=self.batch_size_agentwise*self.n_agent)
      self.whole_mem_actions = deque([], maxlen=self.batch_size_agentwise*self.n_agent)
      self.whole_R_values = np.zeros( (0,1) )
      self.whole_GAE_values = np.zeros( (0,1) )
      self.whole_mem_Rs = deque([], maxlen=self.batch_size_agentwise*self.n_agent)
      self.whole_mem_GAEs = deque([], maxlen=self.batch_size_agentwise*self.n_agent)
      self.whole_mem_probs = deque([], maxlen=self.batch_size_agentwise*self.n_agent)
   ...
   def _step(self, t):
      ...
      for i_agent in range(self.n_agent):
         ...
         with torch.no_grad():
            self.agents[i_agent].action, self.agents[i_agent].prob, self.agents[i_agent].entropy, self.agents[i_agent].value = self.net.forward( state[None, :] )
      ...
      if self.done or (t+1)%self.num_step ==0 :
         for i_agent in range(self.n_agent):
            ...
            with torch.no_grad() :
               _, _, _, V_last = self.net.forward( state[None, :] )
            ...
            self.whole_GAE_values = np.concatenate((self.whole_GAE_values, self.agents[i_agent].GAE_values),axis=0)
            self.whole_mem_probs += self.agents[i_agent].memory_probs

         self.whole_mem_Rs += self.whole_R_values.tolist()
         self.whole_mem_GAEs += self.whole_GAE_values.tolist()

         #trainig
         batch_index = np.arange(len(self.whole_mem_actions))
         tensor_mem_probs = torch.stack(list(self.whole_mem_probs))
         tensor_mem_states = torch.stack(list(self.whole_mem_states))
         tensor_mem_actions = torch.stack(list(self.whole_mem_actions))
         tensor_mem_Rs = torch.tensor( list(self.whole_mem_Rs) )
         tensor_mem_GAEs = torch.tensor( list(self.whole_mem_GAEs) )

         for epoch in range(self.num_epochs) :
            np.random.shuffle(batch_index) 
            for start_id in range(0, len(self.whole_mem_actions), self.minibatch_size):
               end_id = min(start_id + self.minibatch_size, len(self.whole_mem_actions) )
               ...
               probs_new, entropy_new, value_new = self.net.new_probs(replay_states,replay_actions)
               ...
               self.value_loss = torch.mean( (value_new - R_sample)**2 ) 
               self.policy_loss = torch.mean( - torch.min(policy_loss1,policy_loss2) - self.entropy_coef * entropy_new )
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_PPO_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.txt"
   filename_density = "density_PPO_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_PPO_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_PPO_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.gif"
   
   filename_snap1 = "snapshot_PPO_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_t_0_" + str(seed) + "th_try.png"
   filename_snap2 = "snapshot_PPO_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_t_100_" + str(seed) + "th_try.png"
   filename_snap3 = "snapshot_PPO_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_t_" + str(t_max-1) + "_" + str(seed) + "th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_PPO_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_buffer_" + str(hyper.batch_size_agentwise) + "_" + str(seed) + "th_try.png"
