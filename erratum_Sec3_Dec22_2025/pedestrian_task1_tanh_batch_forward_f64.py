...
class Env:
   def __init__(self, hyperparameters, render_mode='off', experience_sharing='on'):
      ...
      self.agents[0].X_esn = np.zeros((self.agents[0].reservoir_size, self.n_agent))
...
class Agent(Object):
   ...
   def choose_action(self, state_list): #epsilon-greedy
      ...
      self.X_in = np.concatenate( [state_array, np.ones((state_array.shape[0],1))], axis=1 )
      Input_state = np.repeat( (self.W_in_s.dot(self.X_in.T) + self.W_res.dot(self.X_esn))[:,:,np.newaxis], self.action_size, axis=2) # Nres*T*a array
      self.X_esn_tilde = np.tanh( Input_state + np.repeat(self.W_in_a[:,np.newaxis,:], Input_state.shape[1], axis=1) )
      X_esn_past = np.repeat(self.X_esn[:,:,np.newaxis], self.action_size, axis=2) 
      X_esn_candidates = X_esn_past + self.lr*(self.X_esn_tilde - X_esn_past) # Nres*T*a array
      self.Q = np.tensordot(self.W_out, np.concatenate([X_esn_candidates, np.ones((1,X_esn_candidates.shape[1],self.action_size))],axis=0), axes=(1,0)).squeeze(axis=0) #T*a array
      ...
      return action_chosen, copy.deepcopy( np.concatenate([self.X_esn, np.ones((1,self.X_esn.shape[1]))],axis=0) ), self.Q[np.arange(self.Q.shape[0]),action_chosen] # returns action and corresponding X_res

   def calculate_Wout(self): 
      reward_array_1 = np.concatenate(self.reward_list, axis=0)
      Xi_temp_array_1 = np.concatenate(self.Xi_temp_list, axis=1).T
      Xi_temp_p0_array_1 = np.concatenate(self.Xi_temp_p0_list, axis=1).T
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_tanh_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   filename_density = "density_tanh_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_tanh_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_tanh_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.gif"
   
   filename_snap1 = "snapshot_tanh_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try_t_0.png"
   filename_snap2 = "snapshot_tanh_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try_t_100.png"
   filename_snap3 = "snapshot_tanh_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_" + str(t_max-1) + "_" + str(seed) + "th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_tanh_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.png"
