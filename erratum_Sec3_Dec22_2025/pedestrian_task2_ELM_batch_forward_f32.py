"""
Source code for task.II using ELM
...
class hyperparameters:
   def __init__(self):
      ...
      self.activation = 'tanh' # 'relu' or 'tanh'
...
class Env:
   def __init__(self, hyperparameters, render_mode='off', experience_sharing='on'):
      ...
      self.state_list = [[None for i in range(self.n_agent_1group)] for j in range(self.n_group)]
   ...
   def _step(self, t):
      ...
      for i_agent in range(self.n_agent):
         ...
         self.state_list[self.agents[i_agent].group][i_agent % self.n_agent_1group] = state.reshape(-1)

      self.whole_action[0], self.whole_Xi_temp_part1[0], self.whole_Q_temp[0] = self.agents[0].choose_action(self.state_list[0])
      self.whole_action[1], self.whole_Xi_temp_part1[1], self.whole_Q_temp[1] = self.agents[self.n_agent_1group].choose_action(self.state_list[1])
      for i_agent in range(self.n_agent):
      ...
      if self.done and self.experience_sharing == 'on':
         ...
         #for i_agent in range(self.n_agent):
            ...
            #if self.agents[i_agent].group == 1 :
               #self.agents[i_agent].W_out = copy.deepcopy(self.agents[self.n_agent_1group].W_out)
...
class Agent(Object):
   ...
   def choose_action(self, state_list): #epsilon-greedy
      ...
      if self.activation == 'relu':
         X_esn_candidates = self._ReLU( Input_state + np.repeat(self.W_in_a[:,np.newaxis,:], Input_state.shape[1], axis=1) )
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   filename_density = "density_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_" + str(seed) + "th_try.gif"
   
   filename_snap1 = "snapshot_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_0_" + str(seed) + "th_try.png"
   filename_snap2 = "snapshot_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_100_" + str(seed) + "th_try.png"
   filename_snap3 = "snapshot_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_" + str(t_max-1) + "_" + str(seed) + "th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "group1_" + str(seed) + "th_try.png"
   ...
   filename_colormap = "colormap_ELM_" + hyper.activation + "_batch_forward_f32_" + str(hyper.n_agent) + "pedestrians_task2_modified_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "group2_" + str(seed) + "th_try.png"
   mean_view_white = (255.0*mean_view.transpose(1,0,2)).astype(np.uint8)
