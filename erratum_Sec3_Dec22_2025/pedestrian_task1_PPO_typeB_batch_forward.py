...
2025/8/20 employed log_prob and (per minibatch) advantage normalization
...
class Env:
   def __init__(self, hyperparameters, render_mode='off', experience_sharing='on'):
      ...
      self.epsilon_advstd = self.hyperparameters.epsilon_advstd 
   ...
   def _step(self, t):
      ...
      with torch.no_grad():
         whole_action, whole_log_prob, whole_entropy, whole_value = self.net.forward( state_tensor )       

      for i_agent in range(self.n_agent):
         self.agents[i_agent].action = whole_action[i_agent:i_agent+1]
         self.agents[i_agent].log_prob = whole_log_prob[i_agent:i_agent+1]
         self.agents[i_agent].value = whole_value[i_agent:i_agent+1]
         ...
         self.agents[i_agent].memory_states.append(state_list[i_agent])
      ...
      for i_agent in range(self.n_agent):
         ...
         self.agents[i_agent].memory_logprobs.append(self.agents[i_agent].log_prob)
      ...
      if self.done or (t+1)%self.num_step ==0 :
         ...
         state_tensor = torch.stack(state_list)
         with torch.no_grad():
            _, _, _, whole_V_last = self.net.forward( state_tensor )    

         for i_agent in range(self.n_agent):
            V_last = whole_V_last[i_agent].detach().item()
            ...
            self.whole_mem_logprobs += self.agents[i_agent].memory_logprobs

         #trainig
         batch_index = np.arange(len(self.whole_mem_actions))
         tensor_mem_logprobs = torch.stack(list(self.whole_mem_logprobs))
         tensor_mem_states = torch.stack(list(self.whole_mem_states))
         tensor_mem_actions = torch.stack(list(self.whole_mem_actions))
         tensor_mem_Rs = torch.tensor( self.whole_R_values )
         tensor_mem_GAEs = torch.tensor( self.whole_GAE_values )
         ...
         for epoch in range(self.num_epochs) :
            ...
            for start_id in range(0, len(self.whole_mem_actions), self.minibatch_size):
               ...
               log_probs_old = tensor_mem_logprobs[minibatch_index].detach()
               ...
               log_probs_new, entropy_new, value_new = self.net.new_probs(replay_states,replay_actions)
               ...
               gae_sample = (gae_sample - gae_sample.mean())/(gae_sample.std() + self.epsilon_advstd)
...
class Agent(Object):
   ...
   def _zip(self):
      return zip(self.memory_logprobs, self.memory_values, self.memory_rewards, self.memory_dones)
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_PPO_standard_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_" + str(seed) + "th_try.txt"
   filename_density = "density_PPO_standard_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_" + str(seed) + "th_try.txt"
   file_learning_curve = open(filename_learning_curve, "w")
   file_density = open(filename_density, "w")

   filename_time = "time_PPO_standard_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_" + str(seed) + "th_try.txt"
   ...
   #gif-animation
   filename_gif = "animation_PPO_standard_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_" + str(seed) + "th_try.gif"
   
   filename_snap1 = "snapshot_PPO_standard_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_t_0_" + str(seed) + "th_try.png"
   filename_snap2 = "snapshot_PPO_standard_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_t_100_" + str(seed) + "th_try.png"
   filename_snap3 = "snapshot_PPO_standard_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_t_" + str(t_max-1) + "_" + str(seed) + "th_try.png"
   ...
   #density plot
   filename_colormap = "colormap_PPO_standard_batch_forward_" + str(hyper.n_agent) + "pedestrians_task1_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.layer_size) + "_lr_" + str(hyper.learning_rate) + "_numstep_" + str(hyper.num_step) + "_" + str(seed) + "th_try.png"
