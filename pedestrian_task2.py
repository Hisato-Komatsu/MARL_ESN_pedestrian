...
class hyperparameters:
   def __init__(self):
      ...
      self.width = 20
      self.height = 20
      self.n_agent = 16 #the number of agents
      ...
      for i_agent in range(self.n_agent):
         ...
         if t >= 1 :
            ...
            if self.experience_sharing == 'on':
               if self.agents[i_agent].group == 0 :
                  self.agents[0].rX += self.agents[i_agent].reward_past * self.agents[i_agent].Xi_temp_part0 
                  self.agents[0].XXT += np.dot(Xi_temp.reshape(-1,1), self.agents[i_agent].Xi_temp_part0.reshape(1,-1) ) 
               elif self.agents[i_agent].group == 1 :
                  self.agents[self.n_agent_1group].rX += self.agents[i_agent].reward_past * self.agents[i_agent].Xi_temp_part0 
                  self.agents[self.n_agent_1group].XXT += np.dot(Xi_temp.reshape(-1,1), self.agents[i_agent].Xi_temp_part0.reshape(1,-1) ) 
            elif self.experience_sharing == 'off':
               self.agents[i_agent].rX += self.agents[i_agent].reward_past * self.agents[i_agent].Xi_temp_part0 
               self.agents[i_agent].XXT += np.dot(Xi_temp.reshape(-1,1), self.agents[i_agent].Xi_temp_part0.reshape(1,-1) ) 
         ...
         if self.done:
            ...
            if self.experience_sharing == 'on':
               if self.agents[i_agent].group == 0 :
                  self.agents[0].XXT += self.agents[i_agent].last_contribution(self.agents[i_agent].Xi_temp_part1) 
               if self.agents[i_agent].group == 1 :
                  self.agents[self.n_agent_1group].XXT += self.agents[i_agent].last_contribution(self.agents[i_agent].Xi_temp_part1) 
            elif self.experience_sharing == 'off':
               self.agents[i_agent].XXT += self.agents[i_agent].last_contribution(self.agents[i_agent].Xi_temp_part1) 
...
class Agent(Object):
   def __init__(self,x,y,condition, kind, hyperparameters):
      ...
      self.W_in_a = np.random.normal(loc=0.0,scale=1.0,size=(self.reservoir_size,self.action_size))
...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + ".txt"
   filename_density = "density_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + ".txt"
   ...
   #gif-animation
   filename_gif = "animation_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + ".gif"
   
   filename_snap1 = "snapshot_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_0.png"
   filename_snap2 = "snapshot_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_100.png"
   filename_snap3 = "snapshot_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "_t_" + str(t_max-1) + ".png"
   ...
   #density plot
   filename_colormap = "colormap_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "group1.png"
   ...
   filename_colormap = "colormap_" + str(hyper.n_agent) + "pedestrians_task2_view_" + str(hyper.agent_eyesight_whole) + "_7_3_Nres_" + str(hyper.reservoir_size) + "_epsilon_" + str(hyper.epsilon_decay) + "to" + str(hyper.epsilon_min) + "group2.png"
   mean_view_white = (255.0*mean_view.transpose(1,0,2)).astype(np.uint8)
